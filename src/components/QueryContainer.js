...
const importedQuery = require('../relay/__generated__/importedQueryQuery.graphql');
...
import QueryContainerFragment from './__generated__/QueryContainerFragment.graphql';
...
const QueryContainer = () => {
  ...
  const submitQuery = () => {
    ...
    setQuery(gql`fragment QueryContainerFragment on Query ${fullQueryText}`);
